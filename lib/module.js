...
const removeSsrAttribute = (html) => {
  return html.replace(/ data-n-head="ssr" async src="https:\/\/pagead2.googlesyndication.com\/pagead\/js\/adsbygoogle.js"/g, ' async src="https:\/\/pagead2.googlesyndication.com\/pagead\/js\/adsbygoogle.js"/g')
}
...
module.exports = function nuxtAdSense (moduleOptions = {}) {
  ...
  // Adsense chokes on the data-n-head="ssr" attribute, so remove it for 
